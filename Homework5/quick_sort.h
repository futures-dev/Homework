...
private:
     ...
     * Getting index of middle element in specified bounds (in case of 2 choices, take left
     * index from two choices).
     *
     * For instance: if "from" equals 5 and "to" 9 equals then the method should return 6
     * (the last real index is 8 and middle can be either 6 or 7, in such cases you need
     * to pick left value (value 6)).
     *
     * Parameters:
     ...
     *
     * Returns:
     *  index of the chosen pivot value (in this case, the last valid array index in specified bounds
     *  (be aware, that the given parameter "to" is given as exclusive index, so it might be not valid)).
     *  Non-negative integer value.
     */
     ...
     *
     * Returns:
     *  index of the chosen pivot value (in this case, a random index in specified bounds (be aware of the fact that
     *  "to" parameter is exclusive)).
     *  Non-negative integer value.
     */
